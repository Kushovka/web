const HomePage = ({ setOpenSystem, homeMusic }) => {
  return (
    <section className="relative max-w-max mx-auto  py-[10px] px-[10px]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center  lg:gap-[84px]  h-screen">
        <div>
          <h1 className="big-text text-red01 font-extrabold lg:text-[538px] text-[280px]">
            HI!
          </h1>
        </div>
        <div className="flex flex-col items-center justify-center w-full lg:gap-[68px] gap-[26px]">
          <div className="flex flex-col md:gap-[46px] gap-[20px]">
            <div>
              <h2 className=" text-white text-center lg:text-left  md:text-[26px] iceland-text">
                Welcome to by personal website.
              </h2>
            </div>
            <div className="flex flex-col gap-[10px] max-w-[640px]">
              <p className="text-center lg:text-left md:text-[20px] leading-[130%] iceland-text">
