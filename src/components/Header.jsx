...
const Header = () => {
  ...
  return (
    <section className="fixed flex items-center justify-between w-screen px-[78px] pt-[27px] pb-[32px] top-0 ">
      ...
      <div className="flex-center gap-[27px]">
        <div>
          <h2 className="iceberg-text text-[12px] font-normal">credits</h2>
        </div>
